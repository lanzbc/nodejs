...
const char* ssid = "Diamond Electric VietNam 2.4GHz";      // Tên mạng Wifi được chỉ định sẽ kết nối (SSID)
const char* password = "devietnam@2019#";  // Password của mạng Wifi được chỉ định sẽ kết nối
const char* server = "192.168.0.123";     // Địa chỉ IP của máy khi truy cập cùng mạng WiFi
